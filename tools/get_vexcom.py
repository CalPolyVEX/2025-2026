...
if system == "Darwin":
    # macOS
    vexcom_path = os.path.join(home_dir, ".vscode/extensions/vexrobotics.vexcode-0.7.2025041600/resources/tools/vexcom/osx")
elif system == "Linux":
    # Linux, check architecture
    arch = platform.machine()
    if arch == "x86_64":
        vexcom_path = os.path.join(home_dir, ".vscode/extensions/vexrobotics.vexcode-0.7.2025041600/resources/tools/vexcom/linux-x64")
    elif arch.startswith("arm"):
        vexcom_path = os.path.join(home_dir, ".vscode/extensions/vexrobotics.vexcode-0.7.2025041600/resources/tools/vexcom/linux-arm32")
    elif arch == "aarch64":
        vexcom_path = os.path.join(home_dir, ".vscode/extensions/vexrobotics.vexcode-0.7.2025041600/resources/tools/vexcom/linux-arm64")
else:
