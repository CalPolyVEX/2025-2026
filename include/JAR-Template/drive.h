...
enum drive_setup {
  ZERO_TRACKER_NO_ODOM, ZERO_TRACKER_ODOM, 
  TANK_ONE_FORWARD_ENCODER, TANK_ONE_FORWARD_ROTATION, TANK_ONE_FORWARD_QUADRATURE,
  TANK_ONE_SIDEWAYS_ENCODER, TANK_ONE_SIDEWAYS_ROTATION, TANK_ONE_SIDEWAYS_QUADRATURE,
  TANK_TWO_ENCODER, TANK_TWO_ROTATION, TANK_TWO_QUADRATURE,
  HOLONOMIC_TWO_ENCODER, HOLONOMIC_TWO_ROTATION, HOLONOMIC_TWO_QUADRATURE
};
