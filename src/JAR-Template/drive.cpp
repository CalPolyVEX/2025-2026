...
{
    if (drive_setup == ZERO_TRACKER_ODOM || drive_setup == TANK_ONE_SIDEWAYS_ENCODER || drive_setup == TANK_ONE_SIDEWAYS_ROTATION || drive_setup == TANK_ONE_SIDEWAYS_QUADRATURE)
    {
    ...
    else if (drive_setup == TANK_TWO_QUADRATURE || drive_setup == HOLONOMIC_TWO_QUADRATURE || drive_setup == TANK_ONE_FORWARD_QUADRATURE)
    {
        return (E_ForwardTracker.position(deg) * (90.0 / 2048.0) * ForwardTracker_in_to_deg_ratio);
    }
    else
    {
...
{
    if (drive_setup == TANK_ONE_FORWARD_ENCODER || drive_setup == TANK_ONE_FORWARD_ROTATION || drive_setup == ZERO_TRACKER_ODOM || drive_setup == TANK_ONE_FORWARD_QUADRATURE)
    {
        return (0);
    }
    ...
    else if (drive_setup == TANK_TWO_QUADRATURE || drive_setup == HOLONOMIC_TWO_QUADRATURE || drive_setup == TANK_ONE_SIDEWAYS_QUADRATURE)
    {
        return (E_SidewaysTracker.position(deg) * (90.0 / 2048.0) * SidewaysTracker_in_to_deg_ratio);
    }
    else
    {
